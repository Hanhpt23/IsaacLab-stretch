...
# Pre-defined configs
##
from omni.isaac.lab_assets import CARTPOLE_CFG , RIDGEBACK_FRANKA_PANDA_CFG, STRETCH_CFG # isort:skip
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # Articulation
    cartpole_cfg = STRETCH_CFG.copy()
    cartpole_cfg.prim_path = "/World/Origin.*/Robot"
    cartpole = Articulation(cfg=cartpole_cfg)

    # return the scene information
    scene_entities = {"stretch": cartpole}
...
def run_simulator(sim: sim_utils.SimulationContext, entities: dict[str, Articulation], origins: torch.Tensor):
    ...
    while simulation_app.is_running():
        ...
        if count % 500 == 0:
            ...
            print(joint_pos.shape, joint_vel.shape)
        ...
        # efforts = torch.randn_like(robot.data.joint_pos) * 0.1
